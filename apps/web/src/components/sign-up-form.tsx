...
export default function SignUpForm({ onSwitchToSignIn }: { onSwitchToSignIn: () => void }) {
  ...
  return (
    <div className="mx-auto w-full max-w-sm">
      ...
      <h1 className="mb-8 text-center text-4xl font-display font-bold text-foreground drop-shadow-sm">Create Account</h1>
      ...
      >
          ...
          <form.Field name="name">
            {(field) => (
              <div className="space-y-3">
                <Label htmlFor={field.name} className="font-bold text-foreground">Name</Label>
        ...
        >
          {({ canSubmit, isSubmitting }) => (
            ...
            >
              {isSubmitting ? "Brewing your account..." : "Sign Up"}
            </Button>
          )}
        </form.Subscribe>
      </form>
      ...
      <div className="mt-8 text-center pt-6 border-t border-border">
        <p className="text-muted-foreground mb-4 font-bold text-sm">Already a fan?</p>
        <Button
          variant="outline"
